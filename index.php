  ...
  <div class="container" style='margin-top:100px'>
    ...
    <div class="row justify-content-center mt-2">
      <?php if ($uid == null) {?>
        ...
        <div id="buttonbar" class="col-md-8 row justify-content-center d-none">
          <button class="btn m-1 btn-warning col-2 btn">
            <i class="fas fa-bell"></i>
            <span class="badge rounded-pill">2</span>
          </button>
          <a class="btn m-1 btn-success col-2" href="/anneli/messages.php">
            <i class="fas fa-comment-dots"></i>
            <span class="badge rounded-pill"><?php echo messages_get_unread () ;?></span>
          </a>
          <button class="btn m-1 btn-info col-2" data-bs-toggle="modal" data-bs-target="#colors">
            <i class="fas fa-cog"></i>
          </button>
          <button class="btn m-1 btn-danger col-2" onclick="logout ()">
...
firebase.auth().onAuthStateChanged(async function(user) {
  if (user) {
    ui ("buttonbar").classList.remove ("d-none")
  }
})
</script>
<?php
